# -*- coding: utf-8 -*-
"""
算法实现：18_信号与图像 / test_digital_image_processing

本文件实现 test_digital_image_processing 相关的算法功能。
"""
...
# test_median_filter 算法
def test_median_filter():
    assert med.median_filter(gray, 3).any()


# test_sobel_filter 算法
...
if __name__ == '__main__':
    # 测试 test_digital_image_processing
