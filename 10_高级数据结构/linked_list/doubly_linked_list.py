...
算法实现：linked_list / doubly_linked_list



本文件实现 doubly_linked_list 相关的算法功能。
...
def test_doubly_linked_list() -> None:
    ...
    # test_doubly_linked_list function
