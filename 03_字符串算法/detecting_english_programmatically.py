# -*- coding: utf-8 -*-
"""
算法实现：03_字符串算法 / detecting_english_programmatically

本文件实现 detecting_english_programmatically 相关的算法功能。
"""
