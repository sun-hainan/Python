# -*- coding: utf-8 -*-
"""
算法实现：04_图算法 / graph_adjacency_list

本文件实现 graph_adjacency_list 相关的算法功能。
"""
...
class TestGraphAdjacencyList(unittest.TestCase):
    ...
    # test_add_and_remove_vertices_repeatedly 函数实现
    ...
    # test_add_and_remove_edges_repeatedly 函数实现
        (
            undirected_graph,
            directed_graph,
            random_vertices,
    ...
    # test_add_vertex_exception_check 函数实现
        (
            undirected_graph,
            directed_graph,
            random_vertices,
    ...
    # test_remove_vertex_exception_check 函数实现
        (
            undirected_graph,
            directed_graph,
            random_vertices,
    ...
    # test_add_edge_exception_check 函数实现
        (
            undirected_graph,
            directed_graph,
            _random_vertices,
    ...
    # test_remove_edge_exception_check 函数实现
        (
            undirected_graph,
            directed_graph,
            random_vertices,
    ...
    # test_contains_edge_exception_check 函数实现
        (
            undirected_graph,
            directed_graph,
            random_vertices,
