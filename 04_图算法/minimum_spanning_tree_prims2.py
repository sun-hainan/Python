# -*- coding: utf-8 -*-
"""
算法实现：04_图算法 / minimum_spanning_tree_prims2

本文件实现 minimum_spanning_tree_prims2 相关的算法功能。
"""
...
if __name__ == "__main__":
    ...
    for node, d in dist.items():
        print(f"  {node}: {d}")
    print(f"\n验证: a-b = {abs(dist['a'] - dist['b'])} (应为 3)")
    print(f"验证: d-b = {abs(dist['d'] - dist['b'])} (应为 15)")
    print(f"验证: a-c = {abs(dist['a'] - dist['c'])} (应为 13)")
