# -*- coding: utf-8 -*-
"""
算法实现：04_图算法 / edmonds_karp_multiple_source_and_sink

本文件实现 edmonds_karp_multiple_source_and_sink 相关的算法功能。
"""
...
class MaximumFlowAlgorithmExecutor(FlowNetworkAlgorithmExecutor):
    # MaximumFlowAlgorithmExecutor 类实现
    def __init__(self, flow_network):
