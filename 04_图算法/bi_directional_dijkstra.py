# -*- coding: utf-8 -*-
"""
算法实现：04_图算法 / bi_directional_dijkstra

本文件实现 bi_directional_dijkstra 相关的算法功能。
"""
...
def pass_and_relaxation(
    # pass_and_relaxation function

    # pass_and_relaxation function
    # pass_and_relaxation 函数实现
    graph: dict,
    v: str,
    visited_forward: set,
...
def bidirectional_dij(
    # bidirectional_dij function

    # bidirectional_dij function
    # bidirectional_dij 函数实现
