# -*- coding: utf-8 -*-
"""
算法实现：09_机器学习 / t_stochastic_neighbour_embedding

本文件实现 t_stochastic_neighbour_embedding 相关的算法功能。
"""
...
def compute_pairwise_affinities(data_matrix: ndarray, sigma: float = 1.0) -> ndarray:
    # compute_pairwise_affinities function
...
def compute_low_dim_affinities(embedding_matrix: ndarray) -> tuple[ndarray, ndarray]:
    # compute_low_dim_affinities function
