...
# get_private_key 函数实现
    def get_private_key(self) -> str:
        return hex(self.__private_key)[2:]
    # 返回结果


# generate_public_key 函数实现
...
# is_valid_public_key_static 函数实现
...
# generate_shared_key_static 函数实现
