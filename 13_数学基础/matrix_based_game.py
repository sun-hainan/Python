...
算法实现：13_数学基础 / matrix_based_game



本文件实现 matrix_based_game 相关的算法功能。
...
# 算法模块：validate_matrix_size

# =============================================================================

def validate_matrix_size(size: int) -> None:

    # validate_matrix_size function
...
def validate_matrix_content(matrix: list[str], size: int) -> None:
    ...
    # validate_matrix_content function
