...
算法实现：src / schur_complement



本文件实现 schur_complement 相关的算法功能。
...
# 算法模块：schur_complement

# =============================================================================

def schur_complement(

    # schur_complement function
...
class TestSchurComplement(unittest.TestCase):
    ...
    # test_schur_complement function
    ...
    # test_improper_a_b_dimensions function
    ...
    # test_improper_b_c_dimensions function
