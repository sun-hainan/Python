# -*- coding: utf-8 -*-
"""
算法实现：special_numbers / harshad_numbers

本文件实现 harshad_numbers 相关的算法功能。
"""
...
def harshad_numbers_in_base(limit: int, base: int) -> list[str]:
    # harshad_numbers_in_base function
...
def is_harshad_number_in_base(num: int, base: int) -> bool:
    # is_harshad_number_in_base function
