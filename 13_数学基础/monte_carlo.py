...
def area_under_curve_estimator(
    # area_under_curve_estimator function
...
def area_under_line_estimator_check(
    # area_under_line_estimator_check function
...
def pi_estimator_using_area_under_curve(iterations: int) -> None:
    # pi_estimator_using_area_under_curve function
    ...
    # function_to_integrate function
