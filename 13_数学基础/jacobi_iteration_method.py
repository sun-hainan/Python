...
算法实现：13_数学基础 / jacobi_iteration_method



本文件实现 jacobi_iteration_method 相关的算法功能。
...
# 算法模块：jacobi_iteration_method

# =============================================================================

def jacobi_iteration_method(

    # jacobi_iteration_method function
...
def strictly_diagonally_dominant(table: NDArray[float64]) -> bool:
    ...
    # strictly_diagonally_dominant function
