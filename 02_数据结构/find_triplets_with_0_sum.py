# -*- coding: utf-8 -*-
"""
算法实现：02_数据结构 / find_triplets_with_0_sum

本文件实现 find_triplets_with_0_sum 相关的算法功能。
"""
...
# =============================================================================
# 算法模块：find_triplets_with_0_sum
# =============================================================================
def find_triplets_with_0_sum(nums: list[int]) -> list[list[int]]:
    # find_triplets_with_0_sum function
...
def find_triplets_with_0_sum_hashing(arr: list[int]) -> list[list[int]]:
    # find_triplets_with_0_sum_hashing function
